...
1. Check that there isn't already an issue about your idea in the [nf-core/ddamsproteomics issues](https://github.com/nf-core/ddamsproteomics/issues) to avoid duplicating work. If there isn't one already, please create one so that others know you're working on this
