...
## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/ddamsproteomics/usage](https://nf-co.re/ddamsproteomics/usage)
...
```bash
nextflow run nf-core/ddamsproteomics --input '*_R{1,2}.fastq.gz' -profile docker
```
...
* `docker`
  ...
  * Pulls software from Docker Hub: [`nfcore/ddamsproteomics`](https://hub.docker.com/r/nfcore/ddamsproteomics/)
* `singularity`
