...
3. Download the pipeline and test it on a minimal dataset with a single command:
    ...
    ```bash
    nextflow run nf-core/ddamsproteomics -profile test,<docker/singularity/conda/institute>
    ```
...
4. Start running your own analysis!
    ...
    ```bash
    nextflow run nf-core/ddamsproteomics -profile <docker/singularity/conda/institute> --input '*_R{1,2}.fastq.gz' --genome GRCh37
    ```
...
The nf-core/ddamsproteomics pipeline comes with documentation about the pipeline which you can read at [https://nf-core/ddamsproteomics/docs](https://nf-core/ddamsproteomics/docs) or find in the [`docs/` directory](docs).
